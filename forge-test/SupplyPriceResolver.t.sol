...
contract SupplyPriceResolver is Test {
    ...
    function setUp() public {
        linearResolver = new SupplyPriceResolver(basePrice, multiplier, tierSize, priceCap, SupplyPriceResolver.PriceFunction.LINEAR);
        exponentialResolver = new SupplyPriceResolver(basePrice, multiplier, tierSize, priceCap, SupplyPriceResolver.PriceFunction.EXP);
    }
